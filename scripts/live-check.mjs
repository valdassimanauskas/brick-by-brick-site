...
await page.goto("https://valdassimanauskas.github.io/brick-by-brick-site/", { waitUntil: "networkidle0", timeout: 90000 });
...
for (const f of [0, 0.2, 0.5, 0.8, 1]) {
  ...
  await page.screenshot({ path: `shots/live-hero-${Math.round(f * 100)}.png` });

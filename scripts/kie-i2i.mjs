...
const created = await (await fetch("https://api.kie.ai/api/v1/jobs/createTask", {
  ...
  body: JSON.stringify({ model: "seedream/5-pro-image-to-image",
    input: { prompt, image_urls: refs.split(","), aspect_ratio: aspect, quality, output_format: "png", nsfw_checker: false } }),
})).json();
